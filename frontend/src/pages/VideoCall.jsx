    ...
    <div>
      {askForUsername === true ? (
        ...
        <div className="meetVideoContainer">
          {showModal ? (
            <div className="chatRoom">
              <div className="chatContainer">
                ...
                <div className="form-floating chattingArea d-flex gap-2">
                  <input
                    value={message}
                  ...
                  <label htmlFor="floatingTextarea">Enter your chat</label>
                </div>
              </div>
            </div>
          ) : (
          ...
          <div className="buttonContainer fs-2">
            ...
            <button
              ...
              className="control-btn call-end-btn"
            >
